...
export default function Toast({ apiResponse, setApiResponse, pageLink }: { apiResponse: string | null, setApiResponse: any, pageLink: string | undefined }) {
    if (apiResponse === 'Added movie to Notion' || apiResponse === 'Added TV show to Notion' || apiResponse === 'Added book to Notion') {
        ...
        return (
            <div id="toast-success" className="flex items-center w-fit max-w-xs p-4 text-gray-800 bg-white border-2 border-green-400 fixed left-5 bottom-5 z-20 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
                ...
                <div>
                    ...
                    <div className="ml-3 text-xs font-normal"><a href={pageLink} className='text-blue-700 underline font-semibold'>View in list</a></div>
                </div>
                <button type="button"
        ...
        return (
            <div id="toast-danger" className="flex items-center w-fit max-w-xs p-4 text-gray-800 bg-white border-2 border-red-400 fixed left-5 bottom-5 z-20 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
        ...
        return (
            <div id="toast-danger" className="flex items-center w-fit max-w-xs p-4 text-gray-800 bg-white border-2 border-blue-400 fixed left-5 bottom-5 z-20 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
