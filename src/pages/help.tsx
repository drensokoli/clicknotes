    ...
    return (
        <div className="flex flex-col justify-center items-center w-full">
            ...
            <div className="flex flex-col py-8 px-8 sm:px-16 justify-center lg:w-4/6 w-full">
                ...
                <p>If you want to learn more about the technical implementaion of this project, make sure to read the <span className="text-blue-500"><Link href="https://github.com/drensokoli/clicknotes">documentation</Link></span>.</p>
                <div className="flex flex-col mt-10 justify-center w-full">
                    ...
                    <p className="pt-4">If you don't already have a Notion account, you can create one <span className="text-blue-500"><Link href="https://www.notion.so/">here</Link></span>.</p>
                    <p>Once you've set up your account, navigate to the <span className="text-blue-500"><Link href="https://www.notion.so/my-integrations">"My integrations"</Link></span> section and click on "Create new integration." Give it a name and Notion will generate an Internal Integration Token for you. This token will be used to establish a connection between ClickNotes and Notion.</p>
                ...
                <div className="flex flex-col mt-10 justify-center w-full">
                    ...
                    <ol className="py-4 px-4">
                        <li> • <span className="text-blue-500"><Link href="https://drensokoli.notion.site/65f8607afe9e4773a82e6a1806ca312c?v=027421f09805471f8d9c8cb6f5fcb1f3">Movies template</Link></span></li>
                        <li> • <span className="text-blue-500"><Link href="https://drensokoli.notion.site/2743e54a24b944558deb1bfd62bc2938?v=85cf49ab3d09472182624fcaa332135d">TV Shows template</Link></span></li>
                        <li> • <span className="text-blue-500"><Link href="https://drensokoli.notion.site/b3d96ee5ab1046deb1d760595a31eff8?v=2e4881e5c77a445c945112aac8e46dbf">Books template</Link></span></li>
                    </ol>
